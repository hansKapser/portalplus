 ...
 * P17OrderPositions
 *
 * @ORM\Table(name="p17_order_positions", indexes={@ORM\Index(name="orderID", columns={"orderID"}), @ORM\Index(name="variation1_id", columns={"variation1_id"}), @ORM\Index(name="variation2_id", columns={"variation2_id"}), @ORM\Index(name="article_id", columns={"article_id"}), @ORM\Index(name="examUserID", columns={"examUserID"})})
 * @ORM\Entity
 */
class P17OrderPositions
{
    /**
     * @var int
     *
