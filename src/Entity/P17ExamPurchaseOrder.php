...
/**
 * P17ExamPurchaseOrder
 *
 * @ORM\Table(name="p17_exam_purchase_order", uniqueConstraints={@ORM\UniqueConstraint(name="ticketID", columns={"ticketID"})}, indexes={@ORM\Index(name="firmID", columns={"firmID"}), @ORM\Index(name="customer_firmID", columns={"customer_firmID", "debitor"}), @ORM\Index(name="examUserID", columns={"examUserID"})})
 * @ORM\Entity
 */
class P17ExamPurchaseOrder
{
    /**
     * @var int
     *
