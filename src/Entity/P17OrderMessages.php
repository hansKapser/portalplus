 ...
 * P17OrderMessages
 *
 * @ORM\Table(name="p17_order_messages", indexes={@ORM\Index(name="orderID", columns={"orderID"}), @ORM\Index(name="firmID", columns={"firmID"}), @ORM\Index(name="user", columns={"user"}), @ORM\Index(name="examUserID", columns={"examUserID"})})
 * @ORM\Entity
 */
class P17OrderMessages
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="postOutID", type="integer", nullable=false)
     */
    private $postoutid;
