 ...
 * P17OrderPositionsKk
 *
 * @ORM\Table(name="p17_order_positions_KK", indexes={@ORM\Index(name="orderID", columns={"orderID"}), @ORM\Index(name="variation1_id", columns={"variation1_id"}), @ORM\Index(name="variation2_id", columns={"variation2_id"}), @ORM\Index(name="article_id", columns={"article_id"})})
 * @ORM\Entity
 */
class P17OrderPositionsKk
{
    /**
     * @var int
     *
     ...
     * @var \P17OrderbookKk
     *
     * @ORM\ManyToOne(targetEntity="P17OrderbookKk")
     * @ORM\JoinColumns({
    ...
    public function getOrderid(): ?P17OrderbookKk
    {
        return $this->orderid;
    }

    public function setOrderid(?P17OrderbookKk $orderid): self
    {
