...
/**
 * P17OrderCreditPositions
 *
 * @ORM\Table(name="p17_order_credit_positions", indexes={@ORM\Index(name="orderID", columns={"orderID"}), @ORM\Index(name="variation1_id", columns={"variation1_id"}), @ORM\Index(name="variation2_id", columns={"variation2_id"}), @ORM\Index(name="article_id", columns={"article_id"}), @ORM\Index(name="p17_order_invoice_positions_ibfk_2", columns={"vat_id"}), @ORM\Index(name="examUserID", columns={"examUserID"})})
 * @ORM\Entity
 */
class P17OrderCreditPositions
{
    /**
     * @var int
     *
     ...
     * @var string|null
     *
     * @ORM\Column(name="sumPosition", type="decimal", precision=10, scale=2, nullable=true)
     */
    private $sumposition;
