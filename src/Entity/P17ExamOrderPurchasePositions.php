...
/**
 * P17ExamOrderPurchasePositions
 *
 * @ORM\Table(name="p17_exam_order_purchase_positions", indexes={@ORM\Index(name="orderID", columns={"orderID"}), @ORM\Index(name="variation1_id", columns={"variation1_id"}), @ORM\Index(name="variation2_id", columns={"variation2_id"}), @ORM\Index(name="article_id", columns={"article_id"})})
 * @ORM\Entity
 */
class P17ExamOrderPurchasePositions
{
    /**
     * @var int
     *
    ...
    /**
     * @var \P17ExamOrderPurchase
     *
     * @ORM\ManyToOne(targetEntity="P17ExamOrderPurchase")
     * @ORM\JoinColumns({
    ...
    public function getOrderid(): ?P17ExamOrderPurchase
    {
        return $this->orderid;
    }

    public function setOrderid(?P17ExamOrderPurchase $orderid): self
    {
