...
/*******************************************************************************
        ...
        Testing:
                ...
                $mail->setFrom("yourEmail@oy.com");
                $mail->setSubject("Your confidential test results");
					 $mail->setText("Dear You,\n\nYour tests were negative.\n\nLove,\nDoctor Smith");
					 $mail->setAttachments("/user/lib/xray.jpg");
                $mail->send();
        ...
        ----------- -----------         ------------------------------------------------
1.0     10/21/1999      R.Chambers              created

1.1     10/17/2000	   Jonathan Barlow			modified to allow sending
        														attachments with text only
        														jon@barlownet.com
        														http://www.barlownet.com/
        														http://www.barlowfarms.com/

        														Also enhanced the sample testing
        														use above so that it would be
...
/*******************************************************************************
        Issues:
                ...
                [x] can only send attachements with HTML and TEXT - fixed by jb.
*******************************************************************************/
/*******************************************************************************
        Function Listing:
                setTo($inAddress)
                ...
                loadtemplate($mydb,$inFileLocation,$inHash,$inFormat)
...
/*******************************************************************************
        Function:               loadtemplate($mydb,$inFileLocation,$inHash,$inFormat)
...
*******************************************************************************/
        function send(){
                ...
                //--HTML AND TEXT AND ATTACHMENTS
					...
					//--TEXT AND ATTACHMENTS ONLY (NO HTML)
                else if($this->mailText != "" && $this->mailHTML == "" && $this->mailAttachments != ""){
