...
h&&(r+="pq-td-border-bottom ");k=["<table class='"+(l?r+"pq-wrap ":r+"pq-no-wrap ")+"' cellpadding=0 cell >"];this.hidearrHS1=[];k.push("<tr class='pq-row-hidden'>");g.show&&(y=g.width+1,k.push("<td style='width:"+y+"px;' ></td>"));for(r=0;r<=b;r++){if(r<e&&r>=n&&(q||d)&&(r=e,r>b))throw"initH>finalH";y=p[r];y.hidden||(y=y.outerWidth,k.push("<td style='width:",y,"px;' pq-col-indx='",r,"'></td>"))}k.push("</tr>");this.offsetRow=null;for(y=0;y<=D;y++)y<a&&y>=s&&(y=a),q=B[y],e=v?q.rowIndx-F:
